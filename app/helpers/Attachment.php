...
class Attachment
{
    ...
    static function addAttachment($file, $model, $folder_name, array $options = []): void
    {
        ...
        $destinationPath = '/home/u503805169/domains/gomltak.com/public_html' . '/uploads/thumbnails/' . $folder_name . '/';
    ...
    static function updateAttachment($file, $oldFiles, $model, $folder_name, array $options = []): void
    {
        ...
        if ($oldFiles) {
            File::delete('/home/u503805169/domains/gomltak.com/public_html' . '/' . $oldFiles->path);
        }
