                        ...
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-7">
                                <div class="card-body">
                                    ...
                                    <p class="mb-4">
                                        You have done <span class="fw-bold">{{ $differenceInpercentage1 }}%</span> more
                        ...
                        <div class="col-lg-6 col-md-12 col-6 mb-4">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <span class="fw-semibold d-block mb-1">{{ __('dashboard.products') }}</span>
                        ...
                        <div class="col-lg-6 col-md-12 col-6 mb-4">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <span class="fw-semibold d-block mb-1">{{ __('dashboard.orders') }}</span>
                ...
                <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                    <div class="card">
                        <div class="row row-bordered g-0">
                            <div class="col-md-12">
                                <h5 class="card-header m-0 me-2 pb-3">{{ __('dashboard.total') }}</h5>
                        ...
                        <div class="col-6 mb-4">
                            <div class="card text-center">
                                <div class="card-body text-center">
                                    ...
                                    <span class="fw-semibold d-block mb-1">{{ __('dashboard.clients') }}</span>
                        ...
                        <div class="col-6 mb-4">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <span class="fw-semibold d-block mb-1">{{ __('dashboard.Transactions') }}</span>
                                ...
                                <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                                    <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                                        <div class="card-title">
                                            <h5 class="text-nowrap mb-2">{{ __('dashboard.report') }}</h5>
                                            <span
                                                class="badge bg-label-warning rounded-pill">{{ Carbon\Carbon::parse($sales[0]->month)->format('F') }}</span>
                                        </div>
                                        <div class="mt-sm-auto">
                                            <small class="text-success text-nowrap fw-semibold"><i
                                                    class="bx bx-chevron-up"></i>{{ $differenceInpercentage }}%</small>
                                            <h3 class="mb-0">${{ number_format($sales[0]->price) }}k</h3>
                                        </div>
                                    </div>
        ...
        <div class="row">
                ...
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between pb-0">
                        <div class="card-title mb-0">
                            <h5 class="m-0 me-2">{{ __('dashboard.orderstatistics') }}</h5>
            ...
            <div class="col-12 col-lg-8 order-2 order-md-6 order-lg-2 mb-4">
                <div class="card">
                    <div class="row row-bordered g-0">
                        <div class="col-md-12">
                            <h5 class="card-header m-0 me-2 pb-3"> {{ __('dashboard.clients') }}</h5>
