...
@section('content')
    <form action="{{ url('offers/' . $offer->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="container mt-3">
            <div class="card mb-4">
                <h5 class="card-header">{{ __('dashboard.offers') }}</h5>
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                <div class="form-group">
                                    <div class="controls">
                                        ...
                                        <input class="form-control" value="{{ $offer->getTranslations('title')[$lang] }}"
                                            name="title[{{ $lang }}]" id=""
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        ...
                                        <input class="form-control"
                                            value="{{ $offer->getTranslations('description')[$lang] }}"
                    ...
                    <button type="submit"onclick="this.disabled=true;this.value='Submitting...'; this.form.submit();"
                        class="btn btn-outline-primary">{{ __('dashboard.edit') }}</button>
