...
@section('content')
    <form action="{{ route('products.store') }} " method="post" enctype="multipart/form-data">
        ...
        <div class="container mt-3">
            <div class="card mb-4">
                <h5 class="card-header">{{ __('dashboard.addnewproduct') }}</h5>
                <div class="card-body">
                    ...
                    <div class="mb-3 ">
                        <label class="form-label">{{ __('dashboard.image') }}</label></br>
                        <label class="btn btn-outline-primary btn-file">
                            {{ __('dashboard.chooseimage') }}<input type="file" name="attachment" style="display: none;" required>
                        </label>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="defaultSelect" class="form-label"> {{ __('dashboard.category') }}</label>
                        <div class="form-group">
                            <select class="form-control" name="category_id" aria-label="Default select example">
                                <option value="">{{ __('dashboard.selectcategory') }}</option>
                    ...
                    <div class="mb-3">
                        <select class="selectpicker" name="colors[]" multiple title="{{ __('dashboard.choosecolors') }}" data-live-search="true">
                        ...
                        <select class="selectpicker" name="sizes[]" multiple title="{{ __('dashboard.choosesizes') }}" data-live-search="true">
                            <optgroup label="Picnic">
                    ...
                    <div class="mb-2">
                        <label class="form-label">{{ __('dashboard.discount') }}</label>
                        <input type="number" value="{{ old('tax') }}" class="form-control" name="tax">
                    </div>
                    ...
                    <button type="submit"onclick="this.disabled=true;this.value='Submitting...'; this.form.submit();"
                        class="btn btn-outline-primary">{{ __('dashboard.add') }}</button>
                </div>
            </div>
        </div>
    </form>
