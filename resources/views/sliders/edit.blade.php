...
<form action="{{url('sliders/'.$slider->id)}}" method="post" enctype="multipart/form-data">
    ...
    <div class="container mt-3">
        <div class="card mb-4">
            <h5 class="card-header">{{ __('dashboard.editslider') }}</h5>
            <div class="card-body">
                ...
                <button type="submit"onclick="this.disabled=true;this.value='Submitting...'; this.form.submit();" class="btn btn-primary">{{ __('dashboard.edit') }}</button>
